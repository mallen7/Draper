...
export clean_email_csv="../${proj_name}/clean_${pid}.csv"
export clean_email_txt="../${proj_name}/clean_${pid}.txt"
export scraped_emails="../${proj_name}/scraped_emails_${pid}.csv"
...
cd work/"${proj_name}"/ || return
cp "${clean_email_csv}" "${clean_email_txt}"
